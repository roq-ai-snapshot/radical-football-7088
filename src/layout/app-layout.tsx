...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Coaches', path: '/coaches', entity: 'coach', service: AccessServiceEnum.PROJECT, icon: FiUser },
  { name: 'Players', path: '/players', entity: 'player', service: AccessServiceEnum.PROJECT, icon: FiUsers },
  { name: 'Parents', path: '/parents', entity: 'parent', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
  {
